                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            ...
                                            onclick="handleAddToCart(event, 'Iphone Xr (128 GB)', 15500, '128 GB', 'images/iphonexr.jpg')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone Xr (128 GB)', 15500, '128 GB', 'images/iphonexr.jpg')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone X (64 GB)', 11500, '64 GB', 'images/iphonex.png')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone X (64 GB)', 11500, '64 GB', 'images/iphonex.png')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone Xs Max (64 GB)', 12990, '64 GB', 'images/iphonexsmax.png')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone Xs Max (64 GB)', 12990, '64 GB', 'images/iphonexsmax.png')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone 8 Plus (64 GB)', 7500, '64 GB', 'images/iphone8plus.webp')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone 8 Plus (64 GB)', 7500, '64 GB', 'images/iphone8plus.webp')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone 7 Plus (64 GB)', 6500, '64 GB', 'images/iphone7plus.webp')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone 7 Plus (64 GB)', 6500, '64 GB', 'images/iphone7plus.webp')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone 8 (64 GB)', 5000, '64 GB', 'images/iphone8.webp')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone 8 (64 GB)', 5000, '64 GB', 'images/iphone8.webp')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone 15 (128 GB)', 47990, '128 GB', 'images/iphone15.webp')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone 15 (128 GB)', 47990, '128 GB', 'images/iphone15.webp')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone 15 Pro Max (1 TB)', 108990, '1 TB', 'images/iphone15pm.png')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone 15 Pro Max (1 TB)', 108990, '1 TB', 'images/iphone15pm.png')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                         <a href="#" 
                                            style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone 13 Pro Max (256 GB)', 58990, '256 GB', 'images/iphone13promax.webp')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone 13 Pro Max (256 GB)', 58990, '256 GB', 'images/iphone13promax.webp')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
                              ...
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                     <div class="buy_bt" style="text-align: left;">
                                       <a href="cart.php"
                                             style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                            onclick="handleAddToCart(event, 'Iphone 12 Mini (128 GB)', 25000, '128 GB', 'images/iphone12mini.webp')">
                                            Add to Cart
                                         </a>
                                     </div>
                                    <div class="buy_bt" style="text-align: right;">
                                        <a href="#" 
                                           style="cursor:pointer; color:#f26522; font-weight:bold; font-size:14px; font-family:'Poppins', sans-serif;"
                                           onclick="handleBuyNowClick(event, 'Iphone 12 Mini (128 GB)', 25000, '128 GB', 'images/iphone12mini.webp')">
                                            Buy Now
                                         </a>
                                     </div>
                                 </div>
